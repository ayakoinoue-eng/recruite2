      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            応募<span className="text-red-600">要項</span>
          </h2>
        ...
        <div className="mt-12 text-center">
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-sm text-gray-700">
              <div>
                <div className="font-semibold text-red-600 mb-2">エントリー締切</div>
                <div>2025年3月31日（月）</div>
              </div>
              <div>
                <div className="font-semibold text-red-600 mb-2">選考期間</div>
                <div>2025年4月1日～4月30日</div>
              </div>
              <div>
                <div className="font-semibold text-red-600 mb-2">内定通知</div>
                <div>2025年5月上旬予定</div>
              </div>
            </div>
          </div>
